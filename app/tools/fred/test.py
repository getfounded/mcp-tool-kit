...
from app.tools.fred.tools import fred_get_series, fred_search, fred_get_series_info, fred_get_category
...
class TestFREDTools(unittest.TestCase):
    ...
    def test_fred_get_series(self):
        ...
        # Create mock data
        mock_series = pd.Series([1.0, 2.0, 3.0], index=pd.date_range(
    ...
    def test_fred_get_category(self):
        ...
        # Create mock data
        mock_category = {"id": 0, "name": "Root",
                         "parent_id": None, "children": [1, 2, 3]}

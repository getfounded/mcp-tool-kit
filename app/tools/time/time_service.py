            ...
            try:
                ...
                try:
                    ...
                    if parsed_time.tzinfo is None:
                        parsed_time = parsed_time.replace(tzinfo=source_timezone_obj)
                except ValueError:
                    # Then try HH:MM format
                    try:
                        parsed_time_obj = datetime.strptime(time, "%H:%M").time()
                        ...
                        # Try more formats
                        try:
                            parsed_time_obj = datetime.strptime(time, "%H:%M:%S").time()
                            now = datetime.now(source_timezone_obj)
                            parsed_time = datetime(
                                now.year,
                                now.month,

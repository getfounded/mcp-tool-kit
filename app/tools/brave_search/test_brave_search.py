...
from app.tools.brave_search.brave_search_tools import brave_web_search, brave_local_search
...
async def test_web_search(mock_service):
    ...
    mock_service.perform_web_search.assert_called_once_with("test query", 10, 0)
...
async def test_web_search_with_params(mock_service):
    ...
    # Verify mock was called with correct parameters
    mock_service.perform_web_search.assert_called_once_with("test query", 5, 10)
...
async def test_local_search(mock_service):
    ...
    # Verify mock was called with correct parameters
    mock_service.perform_local_search.assert_called_once_with("coffee shops", 5)
